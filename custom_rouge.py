...
def rouge_n(reference_summary, created_summary, n, pp_options=None, extended_results=False, language=None):
    """
...
def rouge_l(reference_summary, created_summary, pp_options=None, extended_results=False, language=None):
    """
